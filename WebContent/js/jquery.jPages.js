...
(function ( $, window, document, undefined ) {
    var name = "jPages",
        ...
        defaults = {
            ...
            keyBrowse    : false,
            scrollBrowse : false,
            pause        : 0, // 0表示不自动翻页；有数值表示自动翻页，千进制。1000表示1秒
            clickStop    : false,
            delay        : 50,
    ...
    Plugin.prototype.elemScrolledIntoView = function () {
        ...
        // comment above and uncomment below if you want keyBrowse to happen only when container is completely visible in the page 
        /*return ((elemBottom >= docViewTop) && (elemTop <= docViewBottom) && 
